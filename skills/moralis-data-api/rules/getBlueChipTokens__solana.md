...
**Solana variant:** Fetch established, high-value tokens considered stable investments.
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/discovery/tokens/blue-chip?chain=solana&min_market_cap=150000000&security_score=80&min_token_age_in_days=180&time_frame=1d" \
