...
**Solana variant:** List tokens with high-risk trading activity based on volatility or other factors.
...
```bash
curl -X GET "https://deep-index.moralis.io/api/v2.2/discovery/tokens/risky-bets?chain=solana&max_market_cap=10000000&one_week_holders_change=25&one_week_net_volume_change_usd=500&one_month_volume_change_usd=10000&security_score=70&one_month_price_percent_change_usd=0" \
